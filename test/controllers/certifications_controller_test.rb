...
class CertificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create certification" do
    assert_difference('Certification.count') do
      post certifications_url, params: { certification: { category: @certification.category, name: @certification.name, qr_code: @certification.qr_code, surname: @certification.surname } }
    end
  ...
  test "should update certification" do
    patch certification_url(@certification), params: { certification: { category: @certification.category, name: @certification.name, qr_code: @certification.qr_code, surname: @certification.surname } }
